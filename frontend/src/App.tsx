...
function App() {
  const [page, setPage] = useState<"control" | "acceptance" | "diagnostics" | "admin">("control");
  ...
  return <div className="app-shell">
    ...
    {page === "control" ? <ControlDashboard /> : page === "acceptance" ? <CoalAcceptancePage /> : page === "admin" ? <SupplierAdminPage /> : <div className="diagnostics"><LidarViewer /></div>}
  </div>;
}
export default App;
